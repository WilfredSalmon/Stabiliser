...
#define FST_MSVC_PUSH_AND_DISABLE_WARNINGS(...)                                                                        \
    _Pragma("warning( push )") _Pragma(FST_STRINGIFY(warning(disable :##__VA_ARGS__##)))
...
#define FST_GCC_PUSH_AND_DISABLE_WARNINGS(...)                                                                         \
    _Pragma("GCC diagnostic push") _Pragma(FST_STRINGIFY(GCC warning ignored##__VA_ARGS__))
